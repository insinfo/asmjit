...
void main() {
  ...
  final String outputDirectoryPath = r'C:\MyDartProjects\asmjit\scripts';
  ...
  final outputFile = File('$outputDirectoryPath/asmjit_merged_files.dart.txt');
  ...
  print('Merge completo! Arquivo "$outputFile" criado com sucesso no diretório "$outputDirectoryPath".');
}
